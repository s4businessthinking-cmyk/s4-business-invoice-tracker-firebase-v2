...
import MiddleToolsPanel from "./MiddleToolsPanel";
...
export default function ProductMasterScreen({
  ...
  return (
    <div ref={screenRef} className="pm-root" onKeyDown={moveToNextField}>
      ...
      <div className="pm-reference-grid pm-layout-three-col">
        ...
        <div className="pm-reference-right">
          <div className="pm-list-search">
            <label className="pm-label" htmlFor="pmListSearch">Search</label>
            <input
              id="pmListSearch"
              className="pm-input"
            ...
            />
            <button type="button" className="pm-btn-secondary" onClick={() => setActiveModal("search")}>F10</button>
          </div>
          <ProductListGrid
        ...
        <ActionButtonsRow
            ...
            onOpeningStockEntry={showOpeningTools ? () => setActiveModal("openingStock") : undefined}
            onPrintOpeningStockBarcodes={showOpeningTools ? () => onPrintBarcodes(filteredProducts.filter((p) => parseFloat(p.openingStock || 0) > 0)) : undefined}
            onGenerateWeighingFile={showWeighingExport ? onGenerateWeighingFile : undefined}
            showOpeningTools={showOpeningTools}
            showWeighingExport={showWeighingExport}
          />
      </div>
