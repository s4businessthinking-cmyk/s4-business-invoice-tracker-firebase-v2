...
| Platform | How |
|----------|-----|
| **Windows** | Release থেকে `S4-Invoice-Tracker-Setup-1.0.13.exe` → ইনস্টল |
| **Android** | `S4-Invoice-Tracker-1.0.13.apk` সাইডলোড (Unknown sources ON) |
| **iPhone PWA** | Safari-এ খুলুন: https://s4-business-thinking-31213.web.app → Share → **Add to Home Screen** |
| **PWA zip** | `S4-Invoice-Tracker-PWA-1.0.13.zip` — বিকল্প host (Firebase Hosting / Netlify / IIS) |
